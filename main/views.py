...
# OLD CHANGE PERMISSIONS VIEW. No longer needed with new update, since users can no longer change their own permissions
...
#             legacy_register_iam("unused_arg", request, [curr_user])
#             for ana in Analysis.objects.all():
