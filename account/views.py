        ...
        if form.is_valid():
            ...
            if user.email[-3:] == "edu":
                ...
                try:
                    ...
                    messages.success(request, 'Successfully Registered! You have been approved for use')
                ...
                try:
                    ...
                    messages.success(request, 'Successfully Registered! Please wait for an email from us for access')
                except Exception as e:
                    pass
                    logging.warning("SMTP Client failed:\n" + str(e))
